	...
	>
		<div class="lg:pl-10 lg:pb-32">
			...
			<div class="mt-4 flex flex-1 justify-center space-x-2 lg:mt-6 lg:justify-start">
				...
				>
					<span class="hidden sm:inline">{'cta-1'}</span>
					<span class="inline sm:hidden">{'cta-1-mobile'}</span>
				</a>
				<a sveltekit:prefetch href="/docs/install" class="btn lg:btn-lg normal-case">{'cta-2'}</a>
			</div>
		</div>
	</div>
	<svg
