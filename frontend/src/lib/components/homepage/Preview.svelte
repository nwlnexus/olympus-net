	...
	<div class="px-2 pt-2">
		<div class="navbar text-primary-content rounded-box space-x-1">
			...
			<div class="mx-2 flex-1 justify-center px-2 md:flex md:justify-start">
				<span class="text-2xl font-bold">heliosUI | Dashboard</span>
			</div>
				...
				<div tabindex="0" class="dropdown-content py-2">
					...
					>
						<div class="card-body">
							...
							<div class="mt-4 flex justify-end">
								<a href="/components/card" class="btn btn-primary btn-sm xl:btn-md">See component</a
								>
							</div>
						</div>
					</div>
					...
					<div tabindex="0">
						<div class="flex justify-center gap-8 p-4">
							<label aria-label="checkbox CSS component"
								><input type="checkbox" checked class="checkbox" /></label
							>
							<label aria-label="checkbox CSS component"
								><input type="checkbox" checked class="checkbox checkbox-primary" /></label
							>
							<label aria-label="checkbox CSS component"
								><input type="checkbox" checked class="checkbox checkbox-secondary" /></label
							>
							<label aria-label="checkbox CSS component"
								><input type="checkbox" checked class="checkbox checkbox-accent" /></label
							>
						</div>
					</div>
					<div tabindex="0" class="dropdown-content py-2">
