    ...
    >
      ...
      >
        <span
          ...
          aria-hidden='true'
        >
          <Icon icon='heroicons:sun-solid' width='20' height='20' className={clsx('h-3 w-3 text-gray-400')} />
        </span>
        <span
          className={clsx(
          ...
          aria-hidden='true'
        >
          <Icon icon='heroicons:moon-solid' width='20' height='20' className={clsx('h-3 w-3 text-gray-600')} />
        </span>
      </span>
    </Switch>
  );
